...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , in_ptr{vlSymsp->TOP.in_ptr}
    , wt_ptr{vlSymsp->TOP.wt_ptr}
    , thr_ptr{vlSymsp->TOP.thr_ptr}
    , inp_bram_addr{vlSymsp->TOP.inp_bram_addr}
    , inp_bram_dout{vlSymsp->TOP.inp_bram_dout}
    , wt_bram_addr{vlSymsp->TOP.wt_bram_addr}
    , wt_bram_dout{vlSymsp->TOP.wt_bram_dout}
    , result{vlSymsp->TOP.result}
    , __PVT__constants_pkg{vlSymsp->TOP.__PVT__constants_pkg}
    , rootp{&(vlSymsp->TOP)}
{
